...
SELECT	  
	  ...
	  ISNULL(a.FechaContrato,' ')AS FechaContrato,            CAST(ISNULL(DATEPART(WEEK,a.FechaContrato),0)AS CHAR(4)) SemContrato, ISNULL(miETD.FechaETD,0)AS ETDInicial,
	  CAST(ISNULL(Datepart(Week,miETD.FechaETD),'') AS CHAR(4))AS SemETDIni,  
	  fETD.FechaETD1 ,fETD.FechaETD2,fETD.FechaETD3,fETD.FechaETD4,           
	  ISNULL(maETD.FechaETD,'')AS UltimoETD,            
	  CAST(ISNULL(Datepart(Week,maETD.FechaETD),'') AS CHAR(4))AS SemETDReal, 
	  ...
	  CAST(ISNULL(DATEPART(WEEK,maETA.fechaETA),'')AS CHAR(4))AS SemETAReal,
	  ...
	  CAST(ISNULL(DATEPART(WEEK,DATEADD(DAY,ad.NroDiasETA,maETA.fechaETA)),0)AS CHAR(4)) SemanaIng,  

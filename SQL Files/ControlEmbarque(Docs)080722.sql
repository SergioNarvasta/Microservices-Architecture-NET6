...
Left join (Select a.cia_codcia,a.IdImportacion,a.IdDocumento,(count(a.IdDocumento)) as Total,
		   ...
		   From  CEX_ImportacionREC a   Left Join CEX_Documento b on (a.cia_codcia=b.cia_codcia and a.IdDocumento = b.iddocumento)
		   where  b.flgDocumentoRec = 1 
		   group by a.cia_codcia,a.IdImportacion,a.IdDocumento,a.Mre_flgFisico,a.Mre_flgVirtual )D
...
Left join (Select a.cia_codcia,a.IdImportacion,a.IdDocumento,(count(a.IdDocumento)) as Total,
                Cantidad = (Case When a.Mre_flgFisico =1 or a.Mre_flgVirtual = 1 Then 1 Else 0 End)
		   From  CEX_ImportacionENV a   Left Join CEX_Documento b on (a.cia_codcia=b.cia_codcia and a.IdDocumento = b.iddocumento)
		   where  b.flgDocumentoEnv = 1 
		   group by a.cia_codcia,a.IdImportacion,a.IdDocumento,a.Mre_flgFisico,a.Mre_flgVirtual )D
				 on (a.cia_codcia=d.cia_codcia and a.IdImportacion = d.IdImportacion ) 
group by a.IdImportacion,a.cia_codcia, c.iddocumento
)
Select 
      ...
      a.FechaVB				   ,      a.FechaDLVenc	as FechaDL ,      a.FechaADVenc			   ,
      ...
      Z5.EstadoOC as OCEstatus ,      a.NroUniTrans		       ,      a.FechaIngAlmEst         ,
		...
		CAST(Year(A.FechaETD)AS CHAR(4))     as AñoE, 
		Month(A.FechaIngAlm)as IDMesIngAlm,
		MA.mes_nommes       as MesIngAlm,
		Year(A.FechaIngAlm) as AñoA, 
		Year(A.FechaETA)    as AñoLlegada,
		Month(A.FechaETA)   as IDMesLlegada,
		Mes.mes_nommes      as MesLlegada,
		...
		Space(15) as RefComex,Z5.IdEstadoOC,Z5.EstadoOC
	From CEX_Importacion A
